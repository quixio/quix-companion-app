...
namespace QuixCompanionApp.Droid
{
    ...
    public class TrackingService : Service, ISensorEventListener
    {
        ...
        public override void OnCreate()
        {
            ...
            this.notificationService.SendForegroundNotification("Quix Companion App", "Initializing services...");
        ...
        public async void DoWork()
        {
            ...
            {
                this.notificationService = new NotificationService(GetSystemService(Context.NotificationService) as NotificationManager, this);
                this.notificationService.SendForegroundNotification("Quix Companion App", $"Error: {settingsMessage}");
            ...
            try
            {
                ...
                this.notificationService.SendForegroundNotification("Quix Companion", "Tracking in progress");
