...
namespace QuixTracker.Droid
{
    ...
    {
        public Task<GattStatus> ConnectionTask { get; private set; }

        private readonly BlockingCollection<ParameterDataDTO> locationQueue;
        private readonly CurrentData currentData;
        private readonly ConnectionService connectionService;
        private readonly CancellationToken cancellationToken;
        private readonly TaskCompletionSource<GattStatus> connectionTaskSource;
        ...
        public HeartrateStrapCallback(BlockingCollection<ParameterDataDTO> locationQueue, CurrentData currentData, ConnectionService connectionService, CancellationToken cancellationToken)
        {
            ...
            this.connectionTaskSource = new TaskCompletionSource<GattStatus>();
            this.ConnectionTask = this.connectionTaskSource.Task;
        }

        public override void OnConnectionStateChange(BluetoothGatt gatt, [GeneratedEnum] GattStatus status, [GeneratedEnum] ProfileState newState)
        {

            this.connectionTaskSource.SetResult(status);
