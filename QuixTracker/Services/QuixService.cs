...
namespace QuixTracker.Services
{
    ...
    public class QuixService : IDisposable
    {
        ...
        {
            await this.inputConnection.InvokeAsync("SubscribeToEvent", connectionService.Settings.NotificationsTopic, streamId + "-notifications", eventId);
        }
        ...
        public async Task<string> CreateStream(string deviceId, string rider, string team, string sesionName)
        {
            ...
            await this.outputConnection.InvokeAsync("UpdateStream", this.connectionService.Settings.Topic, streamId, streamDetails);
        ...
        {
            //if (this.inputConnection != null) await this.inputConnection.DisposeAsync();
            //if (this.inputConnection != null) await this.outputConnection.DisposeAsync();
        }
